# Goobi workflow Plugin: goobi-plugin-opac-sample

<img src="https://goobi.io/wp-content/uploads/logo_goobi_plugin.png" align="right" style="margin:0 0 20px 20px;" alt="Plugin for Goobi workflow" width="175" height="109">

This is the Sample Goobi opac plugin. It is used as a reference implementation for future opac plugins. It does contain a configuration file and uses a record from the VZG as demo data request.
...
- Select as template `goobi-workflow/goobi-plugin-opac-sample`
- Select as `Owner` the value `goobi-workflow`
- Define a `Repository name` based on convention, e.g.  `goobi-plugin-opac-myPlugin`
...
- Open Eclipse and checkout the new created Repository. You will find a new project with the name `A-goobi-plugin-opac-sample` there.
- Right-click on the new project and refactor/rename it to your plugin name, e.g. `goobi-plugin-opac-myPlugin`
...
- The plugin is now created and ready to be used. Remember to commit your changes and don't forget to update the README.md file that is located on folder upwards of the eclipse project. As it does not get committed by Eclipse you can commit it with these commands:
  ...
  ```
  cd ~/git/goobi-plugin-opac-myPlugin
...
Detail | Description
--- | ---
**Plugin identifier**       | intranda_opac_sample
